    ...
    async play(gameid:string)
{
          ...
          else
          {
            ...
            user2Cards[0].cards.SCISSOR--;user2flag=true;}
          }
          ...
          throw exception("check your cards one or may be both users minimum no. of cards is not there to play game please purchase")
