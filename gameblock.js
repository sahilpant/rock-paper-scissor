...
var gameContractAddress = '0xc8e181Cb16705F3f34f08a0da9E6FF237831b52E'
var nftContractAddress = '0xbC49A47aA4299a68ec5de4E47f9Cd61FA7ACEc9F'
var starsContractAddress = '0xFe52b37c985cEb534f3003f893e5b75B6B759ac4'
var marketContractAddress = '0x9bD56F93aF436a72Ae56E07006bB385cc3B3f394'
...
///////////////////////////////////////////////////////////////////nft functions//////////////////////////////////////////////////////////
      ...
      async function burn(tokenId , account , privateKey , deployedAddress){  ///burns the card , and card will no longer be accessible 
         try{
                 let cardDelete = await interface_nft.methods.burn(tokenId).encodeABI();
