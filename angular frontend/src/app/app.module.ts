...
// const config:SocketIoConfig={url:`http://localhost:8080/game?token=`+token,options:{query:"gdgdggdgdgdg"}}
...
const config:SocketIoConfig={url:`http://13.59.38.137:8080/game?token=`+token,options:{query:"gdgdggdgdgdg"}}
@NgModule({
  declarations: [
    AppComponent
  ],
